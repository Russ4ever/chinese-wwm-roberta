...
from src.layer_probe_pipeline import (
    load_layer_probe_config, validate_return_probe_outputs, validate_factor_outputs,
)
from src.layer_probe_models import run_return_probe_stage
from src.layer_probe_label_factors import (
    run_label_factor_return_stage, validate_label_factor_return_outputs,
    run_layer_factor_correlation_stage, validate_layer_factor_correlation_outputs,
)
...
rp = step("return_probe(cell21)", lambda: run_return_probe_stage(config,"validation"))
print(validate_return_probe_outputs(rp), flush=True)
lf = step("label_factor_returns(cell23)", lambda: run_label_factor_return_stage(config))
print(validate_label_factor_return_outputs(lf), flush=True)
